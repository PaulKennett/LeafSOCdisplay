...
/*
   ...
   add ability to chage page by: (1) Put Climate Control On, Recirc Air,
...
#include "battery_XBMP.h"      // battery image
...
void loop() {
  ...
  do {
    ...
    // Put Climate On, Air to Recirc, then fan speed -> Page number (up to 4)
    ...
    u8g2.setFont(u8g2_font_logisoso26_tr); // Large numerals-only font
    if (rawGids != 0) {
